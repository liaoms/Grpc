...
set_target_properties(gRPC::absl_flat_hash_set PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gRPC::absl_container_memory;gRPC::absl_hash_function_defaults;gRPC::absl_raw_hash_set;gRPC::absl_algorithm_container;gRPC::absl_core_headers;gRPC::absl_memory;-ignore:4221"
)
...
set_target_properties(gRPC::absl_hash PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gRPC::absl_city;gRPC::absl_config;gRPC::absl_core_headers;gRPC::absl_endian;gRPC::absl_fixed_array;gRPC::absl_meta;gRPC::absl_int128;gRPC::absl_strings;gRPC::absl_optional;gRPC::absl_variant;gRPC::absl_utility;absl_wyhash;\$<LINK_ONLY:-ignore:4221>"
)
...
set_target_properties(gRPC::absl_str_format_internal PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gRPC::absl_bits;gRPC::absl_strings;gRPC::absl_config;gRPC::absl_core_headers;gRPC::absl_type_traits;gRPC::absl_int128;gRPC::absl_span;\$<LINK_ONLY:-ignore:4221>"
)
...
set_target_properties(gRPC::gpr PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gRPC::absl_optional;gRPC::absl_time;gRPC::absl_synchronization;gRPC::absl_strings;gRPC::absl_str_format;gRPC::absl_status;gRPC::absl_memory;gRPC::absl_base"
)
...
set_target_properties(gRPC::grpc_unsecure PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "wsock32;ws2_32;crypt32;gRPC::zlibstatic;gRPC::cares;gRPC::address_sorting;gRPC::re2;gRPC::upb;gRPC::gpr;gRPC::address_sorting;gRPC::upb;gRPC::absl_optional;gRPC::absl_strings;gRPC::absl_statusor;gRPC::absl_status;gRPC::absl_inlined_vector;gRPC::absl_flat_hash_map"
)
